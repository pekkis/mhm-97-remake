...
Pankki, jossa joukkueen tili (tai velka) on, MENEE KONKURSSIIN! KAIKKI pankin s„„st"t & velat mit„t"id„„n,
ja kansa vaatii rahojaantakaisin... TURHAAN!!!
Pankinjohtaja Sulf Undqvist valittelee tapahtunutta, ja matkustaa toipumaan Caymansaarten huvilalleen."
raha = 0
*/
...
const event: MHMEvent<UndqvistData> = {
  type: "manager",
