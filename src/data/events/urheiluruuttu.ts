...
import { managersTeamId, managersDifficulty } from "../../data/selectors";
...
const event: MHMEvent<UrheiluruuttuData> = {
  type: "manager",
  ...
  process: function* (data) {
    ...
    const moraleGain = data.moraleGain;
